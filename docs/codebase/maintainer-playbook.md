...
- [ ] Use `internal/components/opencodeplugin/` for OpenCode TUI plugin registration: external plugins add package names, while k.to Logo writes/registers the managed local plugin file.
