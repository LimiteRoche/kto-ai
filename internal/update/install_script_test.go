...
func TestInstallScriptBetaGoInstallBypassesPublicGoProxy(t *testing.T) {
	...
	for _, want := range []string{
		"prepend_go_env_pattern GONOSUMDB github.com/LimiteRoche/kto-ai/v2",
		"prepend_go_env_pattern GOPRIVATE github.com/LimiteRoche/kto-ai/v2",
		"prepend_go_env_pattern GONOPROXY github.com/LimiteRoche/kto-ai/v2",
...
`)
	...
	want := strings.Join([]string{
		"github.com/LimiteRoche/kto-ai/v2,example.com/private",
		"github.com/LimiteRoche/kto-ai/v2,github.com/acme/*",
		"github.com/LimiteRoche/kto-ai/v2",
	}, "\n")
	if got != want {
...
func TestWindowsInstallScriptBetaGoInstallPreservesGoProxyBypassEnv(t *testing.T) {
	...
	script := string(content)
	for _, want := range []string{
		"Add-GoEnvPattern -Name \"GONOSUMDB\" -Pattern \"github.com/LimiteRoche/kto-ai/v2\"",
		"Add-GoEnvPattern -Name \"GOPRIVATE\" -Pattern \"github.com/LimiteRoche/kto-ai/v2\"",
		"Add-GoEnvPattern -Name \"GONOPROXY\" -Pattern \"github.com/LimiteRoche/kto-ai/v2\"",
	...
	for _, clobber := range []string{
		"$env:GONOSUMDB = \"github.com/LimiteRoche/kto-ai/v2\"",
		"$env:GOPRIVATE = \"github.com/LimiteRoche/kto-ai/v2\"",
		"$env:GONOPROXY = \"github.com/LimiteRoche/kto-ai/v2\"",
	} {
		if strings.Contains(script, clobber) {
